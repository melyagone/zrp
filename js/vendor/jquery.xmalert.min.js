    ...
    s.fn.xmalert = function(e) {
        ...
        var a, i, n, o = {},
            ...
            d = function(t) {
                ...
                switch (t) {
                    case "item":
                        e.addClass("item").append('<figure class="user-avatar">								<img src="' + o.settings.imgSrc + '" alt="user-image">						     </figure>    						 <p class="info">' + o.settings.title + '</p>    						 <p class="timestamp">' + o.settings.timestamp + '</p>    						 <span class="sl-icon ' + o.settings.iconClass + '"></span>    						 <img class="close-btn" src="images/dashboard/notif-close-icon.png" alt="close-icon">						');
                        break;
                    case "messageInfo":
                        e.addClass("message info").append('<div class="message-type"></div>    						 <p class="text-header">' + o.settings.title + '</p>    						 <p class="info">' + o.settings.paragraph + '</p>    						 <img class="close-btn" src="images/dashboard/notif-close-icon.png" alt="close-icon">						');
                        break;
                    case "messageSuccess":
                        e.addClass("message success").append('<div class="message-type"></div>    						 <p class="text-header">' + o.settings.title + '</p>    						 <p class="info">' + o.settings.paragraph + '</p>    						 <img class="close-btn" src="images/dashboard/notif-close-icon.png" alt="close-icon">						');
                        break;
                    case "messageError":
                        e.addClass("message error").append('<div class="message-type"></div>    						 <p class="text-header">' + o.settings.title + '</p>    						 <p class="info">' + o.settings.paragraph + '</p>    						 <img class="close-btn" src="images/dashboard/notif-close-icon.png" alt="close-icon">						');
                        break;
                    case "review":
                        e.addClass("review").append('							<p class="text-header">' + o.settings.title + '</p>    						<p class="info">' + o.settings.paragraph + '</p>							<p class="timestamp">' + o.settings.timestamp + '</p>							<div class="review-buttons">								<a href="' + o.settings.buttonSrc[0] + '" class="button mid primary">									<span class="sl-icon icon-like"></span>								</a>								<a href="' + o.settings.buttonSrc[1] + '" class="button mid tertiary">									<span class="sl-icon icon-dislike"></span>								</a>							</div>							<img class="close-btn" src="images/dashboard/notif-close-icon.png" alt="close-icon">						');
                        break;
                    case "survey":
                        e.addClass("survey").append('							<figure class="survey-img">								<img src="' + o.settings.imgSrc + '" alt="survey-img">							</figure>							<p class="text-header">' + o.settings.title + '</p>							<p class="info">' + o.settings.paragraph + '</p>							<p class="timestamp">' + o.settings.timestamp + '</p>							<a href="' + o.settings.buttonSrc[0] + '" class="button mid dark close-btn">' + o.settings.buttonText + '</a>							<img class="close-btn" src="images/dashboard/notif-close-icon.png" alt="close-icon">						')
                }
